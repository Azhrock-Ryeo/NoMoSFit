...
export default function WorkoutNavigator() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      <Stack.Screen name="BeforeWorkout" component={BeforeWorkoutScreen} />
      <Stack.Screen name="DuringWorkout" component={DuringWorkoutScreen} />
      <Stack.Screen name="AfterWorkout" component={AfterWorkoutScreen} />
    </Stack.Navigator>
  );
}